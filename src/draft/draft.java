...
//            System.out.println("Ingrese el número " + (i+1));//we ask the user for a number (nine times)
//            numbers[i] = scan.nextInt();//The introduced numbers are assigned, one by one, to the list
//        //  System.out.println("array: " + numbers[i]); //prints your number immediately after you enter it
//            
//        }
//        //We test the array lenght to prove there are 9 numbers
//        System.out.println("Introdujo en total " + numbers.length + " números");
//        //We test the array, one by one
////        System.out.println("PRINT de prueba " + numbers[0]);
////        System.out.println("PRINT de prueba " + numbers[1]);
////        System.out.println("PRINT de prueba " + numbers[2]);
////        System.out.println("PRINT de prueba " + numbers[3]);
////        System.out.println("PRINT de prueba " + numbers[4]);
////        System.out.println("PRINT de prueba " + numbers[5]);
////        System.out.println("PRINT de prueba " + numbers[6]);
////        System.out.println("PRINT de prueba " + numbers[7]);
////        System.out.println("PRINT de prueba " + numbers[8]);
//
//        //We print all again with a 'for' cicle 
////        for(int j =0; j<numbers.length;j++){
////        System.out.println("PRINT con for " + numbers[j]);
////        System.out.println("");
////        }
//        
////        //WE DO THE SAME, BUT WITH AN ARRAYLIST, 'CAUSE YOLO
////        Scanner scan2 = new Scanner(System.in);//We star making the scanner, for the user tu introduce the data
////        System.out.println("<2-.>Ingrese 8 números iguales y 1 mayor");//We ask for the 9 numbers to be given by the user
////        ArrayList<Integer> arreglo = new ArrayList<>();//We don't have to limit the number of variables
////        for(int k=0; k< numbers.length; k++){
////            System.out.println("Ingrese número " + (k+1));
////            arreglo.add(scan.nextInt());
////        } 
////        System.out.println("El otro arreglo completo " + arreglo);
////        System.out.println("Datos separados:  " + arreglo.get(0) + " y " + arreglo.get(3));//we use the index to get the element at the specified position in this list 
////        
//        
//        //We divide the 9 numbers in 3 blocks of 3 (the last one is not needed)
//        int x = numbers[0] + numbers[1] + numbers[2];
//        int y = numbers[3] + numbers[4] + numbers[5];
//      //int z = numbers[6] + numbers[7] + numbers[8];//We don't need this one displayed :v
//    
